...
from helper import bch250_226_encode, bch226_250_decode, binary_to_hex

BASE_DIR = os.path.dirname(os.path.abspath(__file__))
FRONTEND_BUILD_DIR = os.path.normpath(
...
def serve_frontend(path: str):
    # Serve static files from the React build; fall back to index.html for SPA routes
